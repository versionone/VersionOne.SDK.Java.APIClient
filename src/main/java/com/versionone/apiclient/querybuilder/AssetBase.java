...
import com.versionone.apiclient.querybuilder.interfaces.*;
public class AssetBase implements IAssetBase {
	...
	private Map<String, List<Pair<String, AddOrRemove>>> _relationshipAssetReferencesMap = 
	new HashMap<String, List<Pair<String, AddOrRemove>>>();
	
	private Map<String, Boolean> _modifiedAttributes = new HashMap<String, Boolean>();
	...
	{
		if (attributes != null) _wrapped = JSONObject.stringToValue((String) attributes);
